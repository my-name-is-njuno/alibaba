                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="proffesion" type="proffesion" class="form-control @error('proffesion') is-invalid @enderror" name="proffesion" value="{{ old('proffesion') }}" required autocomplete="proffesion">
